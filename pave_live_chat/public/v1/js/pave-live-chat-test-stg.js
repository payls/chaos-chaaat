function PaveChat(e) {
  (e = {
    ...{
      iframeUrl: 'https://livechat-staging.yourpave.com/',
      styleUrl:
        'https://livechat-staging.yourpave.com/v1/css/pave-live-chat.css',
      user: null,
      isTECform: false,
    },
    ...e,
    ...
    (this.construct_uis = function (e) {
      ...
      i.setAttribute(
        'src',
        'https://api-staging.chaaat.io/v1/services/trigger-image?id=' +
          e.agency_id,
      ),
