function PaveChat(e) {
  (e = {
    ...{
      iframeUrl: 'https://livechat-qa.yourpave.com/',
      styleUrl: 'https://livechat-qa.yourpave.com/v1/css/pave-live-chat.css',
      user: null,
      isTECform: false,
    },
    ...e,
    ...
    (this.construct_uis = function (e) {
      ...
      i.setAttribute(
        'src',
        'https://api-qa.chaaat.io/v1/services/trigger-image?id=' + e.agency_id,
      ),
