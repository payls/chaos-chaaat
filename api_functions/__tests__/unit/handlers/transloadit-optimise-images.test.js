const transloadOptimiseImages = require('../../../src/handlers/transloadit-optimise-images.js');

describe('Test for transloadit-optimise-images', function () {
  ...
  it('Verifies the payload is logged', async () => {
    ...
    await transloadOptimiseImages.optimiseImages(payload, null);
