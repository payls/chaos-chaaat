...
module.exports = (sequelize, DataTypes) => {
  class shortlisted_project_comment_attachment extends Model {
    /**
    ...
    static associate(models) {
      ...
      shortlisted_project_comment_attachment.belongsTo(
  ...
  shortlisted_project_comment_attachment.init(fields, {
    sequelize,
    modelName: 'shortlisted_project_comment_attachment',
    freezeTableName: true,
    timestamps: false,
  });
  return shortlisted_project_comment_attachment;
};
