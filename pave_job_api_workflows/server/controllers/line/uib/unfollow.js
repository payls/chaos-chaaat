...
module.exports.makeController = (models) => {
  ...
  lineCtl.processContactUnfollow = async (data, log, { transaction } = {}) => {
    try {
      const funcName = 'lineCtl.processContactUnfollow';
      const {
        agency_id,
      ...
      if (!h.isEmpty(contact)) {
        ...
        if (!h.isEmpty(lineUserProfile.displayName)) {
        ...
        await lineMessageTrackerModel.create(
          {
            ...
            msg_body: `Contact unfollowed ${agency?.dataValues?.agency_name}`,
