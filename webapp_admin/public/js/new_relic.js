      ...
      class N extends f {
        ...
        constructor(e, t) {
          ...
          super(e, t, C.t, r),
            l.il &&
              ((0, S.N)(
                () => (0, _.p)('docHidden', [(0, j.z)()], void 0, C.t, this.ee),
                !0,
              ),
              (0, D.bP)('pagehide', () =>
                (0, _.p)('winPagehide', [(0, j.z)()], void 0, C.t, this.ee),
              ),
              this.importAggregator());
        }
      }
      ...
      class Q extends f {
        ...
        constructor(e, t) {
          ...
          if ((super(e, t, V.t, i), (0, n.OP)(e).xhrWrappable)) {
            (this.dt = new Z(e)),
              (this.handler = (e, t, r, n) => (0, _.p)(e, t, r, n, this.ee));
            try {
              const e = {
                xmlhttprequest: 'xhr',
                fetch: 'fetch',
...
function getEnv() {
  ...
  // staging environment
  else if (hostName.indexOf('staff-staging.yourpave.com') > -1) {
    return processEnvironment(debug, 'staging');
  }
  // qa environment
  else if (hostName.indexOf('staff-qa.yourpave.com') > -1) {
...
const credentials = {
  development: {
    agentId: '1120030543',
    applicationId: '1120030543',
  },
  staging: {
    agentId: '956576632',
    applicationId: '956576632',
  },
  // 'qa': {
  //     agentId: '1120030697',
  //     applicationId: '1120030697',
  // },
  qa: {
    agentId: '1117628682',
    applicationId: '1117628682',
  },
  // 'production': {
  //     agentId: '1120030699',
  //     applicationId: '1120030699',
  // },
  production: {
    agentId: '1117341438',
    applicationId: '1117341438',
  },
};
...
NREUM.loader_config = {
  accountID: '3375261',
  trustKey: '3375261',
  agentID: credentials[env].agentId,
  licenseKey: 'NRJS-b5747faf95d4fcfd49b',
  applicationID: credentials[env].applicationId,
};
NREUM.info = {
