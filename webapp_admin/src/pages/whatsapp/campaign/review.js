...
export default function CampaignTemplateList() {
  ...
  /**
   * Description
   * Function to submit and initiate reviewed campaign
   * @function
   * @name handleSubmit
   * @kind function
   * @memberof CampaignTemplateList
  ...
  function handleSubmit() {
    ...
    h.general.prompt(
      {
        message: 'Are you sure you want to approve and initiate this campaign?',
      },
              ...
              <div className="">
                <div className="pl-3 pr-3 pb-2">
                  <div className="d-flex justify-content-between">
                    ...
                    >
                      Review WhatsApp Campaign Draft
                    </h1>
                  </div>
                </div>
                <div
