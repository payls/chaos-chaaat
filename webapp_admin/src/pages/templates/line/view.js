...
import BasicTemplateView from '../../../components/Line/BasicTemplateView';
import ConfirmTemplateView from '../../../components/Line/ConfirmTemplateView';
import ButtonTemplateView from '../../../components/Line/ButtonTemplateView';
      ...
      if (line_template_id) {
        ...
        if (h.cmpStr(template_type, 'BASIC')) {
            ...
            if (h.cmpStr(content.type, 'text')) {
              ...
              if (!h.isEmpty(content.quickReply)) {
                ...
                quickReplyItems.forEach(function (item) {
                  form.quick_replies.push({ value: item.action.text });
                });
              }
            }
          });
          ...
          if (!h.isEmpty(contents.template.actions)) {
            ...
            handleButtonOptionAction('QUICK_REPLY');
            quickReplyItems.forEach(function (item) {
              form.quick_replies.push({ value: item.text });
            });
          }
