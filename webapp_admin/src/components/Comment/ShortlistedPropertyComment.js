...
//   useEffect(() => {
//     (async () => {
//       await getCommentByCommentId(comment.shortlisted_property_comment_id);
//     })();
//   }, [comment]);
...
//       const commentId =
//         apiRes.data.shortlisted_property_comment
//           .shortlisted_property_comment_id;
//       // comment returned is child comment
//       if (commentId !== commentState.shortlisted_property_comment_id) {
//         setCommentState((prevCommentState) => {
//           const newCommentState = { ...prevCommentState };
//           newCommentState.shortlisted_property_comment_reply =
//             prevCommentState.shortlisted_property_comment_reply.map(
//               (childComment) => {
//                 if (
//                   childComment.shortlisted_property_comment_id === commentId
//                 ) {
//                   return apiRes.data.shortlisted_property_comment;
//                 }
//                 return childComment;
//               },
//             );
...
//       } else setCommentState(apiRes.data.shortlisted_property_comment);
//     }
//   };
...
//         </div>
//         <div className="row">
//           <div className="col-2 small-sc-title">Property</div>
//           <div className="col-10 small-sc-desc">
//             {h.notEmpty(comment) &&
...
//         key={'parent_comment_property'}
//       />
//       {commentState &&
//         commentState.shortlisted_property_comment_reply &&
//         commentState.shortlisted_property_comment_reply.map((reply, i) => {
//           return (
//             <Comment
//               key={i}
//               contact={contact}
