...
const othersIcon =
  'https://cdn-staging.yourpave.com/shortlisted_project/comment/attachment/4ae8d6e8612505af004c783afdaac081647a11cffbe3ae701ed64462037a587e6d7db8d738ac0b5be2d10915c990991b228e87caf4c1db687c892235b9b23f99.png';

export default function ShortlistedProjectAttachmentCard(props) {
  const {
    uploading = false,
    attachment,
      ...
      {uploading ? (
        ...
        >
          ...
          {image.includes(fileType) ? (
            <img
              key={
                attachment.shortlisted_project_comment_attachment_id != null
        ...
        <div
          ...
          style={{
            width: image.includes(fileType) ? 'auto' : '10%',
            minWidth: '80px',
          }}
        >
          {image.includes(fileType) && (
