...
// import Preview from '../Link/preview/pages/preview';
// import { notEmpty } from '../Link/preview/helpers/general';
...
// import CommonImage from '../Link/preview/components/Common/CommonImage';
// import CreateLinkFormStep3 from '../../Sale/Link/partials/CreateLinkFormStep3';
...
// const OGPS_OPTIONS = [
//   { label: 'Chaaat Standard', value: 'pave' },
//   { label: 'OGPS Garden Towers Landing Page', value: 'ogps' },
...
//   const [proposalTemplateId, setProposalTemplateId] = useState(null);
...
//   const handleProjectImageCallBack = async (childData) => {
//     await setProjectImages((current) => [...current, childData]);
//   };
...
//           false,
//         );
//         setAgency(agencyAPIRes.data.agency);
//         setAgencyId(agencyUser.agency_fk);
//         const currDate = new Intl.DateTimeFormat('en-AU', {
//           dateStyle: 'medium',
//           timeStyle: 'medium',
//         }).format(new Date());
//         setTemplate(
//           'Proposal Template for ' +
//             agencyAPIRes.data.agency.agency_name +
//             ' (' +
//             currDate +
//             ')',
//         );
...
//         let parsedProj = handleProjectOptionList(projects);
...
//           let parsedProj = handleProjectOptionList(projectApiRes.data.projects);
...
//       setProjectList(parsedProj);
//     }
//   }, [selectedCountryList, selectedCityList]);
...
//             { label: 'Raeon Internation Landing Page', value: 'raeon' },
//             { label: 'Strength Culture Landing Page', value: 'strculture' },
//             { label: 'Breathe Pilates Landing Page', value: 'breathe_pilates' },
//             {
...
//         const country = h.general.getCountry(project.location_google_place_raw);
//         if (selectedCountryList.includes(country) && !cityList.includes(city)) {
//           cityList.push(city);
//         }
...
//     // set the initial selected projects. - removed checking if contact exists
//     let projectIdList = [];
//     let propertyProjects = [];
//     let shortlistedProjects = [];
//     if (h.isEmpty(selectedProjects)) {
//       setProjects(projects);
...
//       formDataStep1.proposal_template_id = proposalTemplateId;
//     formDataStep1.name = template;
//     formDataStep1.agency_id = agencyId;
...
//     const [proposalTemplate] = await Promise.all([
//       api.proposalTemplate.createOrUpdate(formDataStep1, false),
//     ]).catch(() => {
//       h.general.alert('error', {
...
//     //   ),
//     // );
//     setProposalTemplate(proposalTemplate.data.proposal_template);
//     if (h.isEmpty(proposalTemplateId)) {
//       setProposalTemplateId(
//         proposalTemplate.data.proposal_template.proposal_template_id,
//       );
//     }
//   };
...
//         await previewAPI.proposalTemplateShortlistedProject.saveShortlistedProjectSettings(
//           m,
//           false,
//         );
//       } catch (err) {
...
//     selectedProjects.length > 0 && agencyId && agencyUser;
...
//     switch (step) {
//       case 1:
//         return 'Invite a buyer to view properties on the pave platform in three simple steps';
//       case 2:
...
//               parentProjectImageCallBack={handleProjectImageCallBack}
//               permalinkTemplate={selectedTemplate}
//             />
