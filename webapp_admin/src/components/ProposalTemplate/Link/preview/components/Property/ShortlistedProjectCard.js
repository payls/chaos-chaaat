...
// import ImageHoverSetting from '../../../../../Sale/Link/preview/components/Partials/ImageHoverSetting';
...
//       (f) =>
//         f?.shortlisted_project_id ===
//         shortlistedProject.shortlisted_project_proposal_template_id,
//     );
...
//             await api.proposalTemplateShortlistedProject.getShortlistedProjectSettings(
//               {
...
//             } else {
//               //get shortlisted project property proposal template
//               const projectTemplatePropertiesApi =
//                 await api.proposalTemplateShortlistedProject.getShortlistedProjectPropertyProposalTemplate(
//                   {
//                     shortlisted_project_proposal_template_id:
//                       shortlistedProject.proposal_template_fk,
//                   },
//                   false,
//                 );
//               const propertiesData =
//                 projectTemplatePropertiesApi.data
...
//                       property.shortlisted_property_proposal_template_id,
...
//     console.log(shortlistedProject);
...
//       reorderMediasArray = shortlistedProject.project.project_media ?? [];
//     }
...
//       const projectSettingsDataIndex = settingsData.findIndex(
//         (x) =>
//           x.shortlisted_project_id === propertySetting.shortlisted_project_id,
//       );
//       const newSettingsObj = settingsData;
//       if (projectSettingsDataIndex !== -1) {
//         const propertySettingsDataIndex = newSettingsObj[
//           projectSettingsDataIndex
//         ].shortlisted_property_setting_proposal_templates.findIndex(
//           (x) =>
...
//           newSettingsObj[
//             projectSettingsDataIndex
//           ].shortlisted_property_setting_proposal_templates.push(
//             propertySetting,
//           );
//         }
//       }
...
//     (type) => {
//       return (
//         shortlistedProject.project.project_media.filter((f) => {
//           const media_tags = f.project_media_tags.map((m) => m.tag);
...
//         medias[i].project_name = shortlistedProject.project.name;
//         medias[i].is_selected = false;
//         newf.push(medias[i]);
//       });
//     }

//     parentProjectImageCallBack(newf);
//     return carouselUpdated ? newf : medias;
...
//       {shortlistedProject?.project?.project_media &&
//         shortlistedProject?.project?.project_media.length > 0 &&
//         filteredMediaUnits &&
//         projectSettings && (
...
//                     >
//                       {' '}
//                       {h.translate.localize('render_3d', translate)}{' '}
//                     </label>
//                   </div>
//                 )}
//               </div>
...
//       {!h.notEmpty(
//         shortlistedProject.shortlisted_property_proposal_templates,
//       ) && (
...
//       ) && (
//         <div>
//           <div className="container py-3" ref={propertyRef}>
//             <h3
