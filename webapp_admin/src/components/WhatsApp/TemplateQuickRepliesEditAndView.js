  ...
  return (
    <>
      ...
      <button
        ...
        disabled={buttons.length === 10 || disabled}
        style={{
          display: buttons.length === 10 || disabled ? 'none' : 'block',
          color: buttons.length === 10 || disabled ? '#c5c5c5' : 'inherit',
        }}
      >
        <FontAwesomeIcon
          icon={faPlusCircle}
