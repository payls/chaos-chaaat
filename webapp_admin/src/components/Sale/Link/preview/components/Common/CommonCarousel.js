...
//           if (isYoutube) {
//             const videoId =
//               item?.src?.split('/')[item.src.split('/').length - 1];
...
//         onSlideChange={(e) =>
//           !swiperThumbnails ? handleSwiperSlideChange(e) : null
//         }
//         onAfterInit={(swiper) => {
//           setTimeout(() => {
//             swiper?.lazy?.load();
...
//             imgSrc = 'https://cdn.yourpave.com/assets/3D-CLICK.jpg';
//           }
//           return (
...
//                 className="swiper-lazy animate-fadeIn"
...
//   const swiperThumbs = React.useMemo(() => {
//     return (
//       <Swiper
...
//           return (
//             <SwiperSlide
//               ref={allCarouselItems.indexOf(item) === 0 ? swiperSlideRef : null}
//               key={`thumbnail-` + i}
//             >
//               <img
//                 key={`img-` + i}
