    ...
    <main id="breathe-pilates-root">
      ...
      <div className="centered container l">
        ...
        <div>
          <p style={{ textAlign: 'center' }}>
            Moving well is about having the awareness, strength and flexibility
            required to control your body in daily activities.
          </p>
          <p style={{ textAlign: 'center' }}>
      ...
      <div style={{ textAlign: 'center' }} className="container l">
        ...
        <p style={{ textAlign: 'center' }}>
          ...
          method as part of our rehabilitative and fitness training programmes.
          With over 100 different types of specialised classes a week across 4
          locations island-wide, you will be able to find a class that suits
          your schedule at one of our studios. Whether it is about reformer
          classes, rehab or prenatal classes, we got you covered.
        </p>
        <p style={{ textAlign: 'center' }}>
          ...
          Yoga. GYROTONIC® is excellent for boosting the spine’s functional and
          rotational capacity, as well as other rotational joints including the
      ...
      >
        ...
        <p style={{ textAlign: 'center' }}>
          ...
          Pilates instructors with a wealth of experience in helping individuals
          achieve the freedom of movement through Pilates. We demonstrate
          Pilates movements, guide individuals of all ages, shapes, and sizes to
          practice them correctly, and motivate them with positive feedback.
        </p>
        ...
        {viewMore && (
          <>
            ...
            <p style={{ textAlign: 'center' }}>
              ...
              instructors are open and friendly and love sharing their knowledge
              so you get the best out of your session.
            </p>
            ...
            <p style={{ textAlign: 'center' }}>
              Each one of our trainers know the values and deep understanding of
              the core Pilates methods created by Joseph Pilates. Because
            ...
            <p style={{ textAlign: 'center' }}>
              ...
              explored different strategies and learning styles to connect with
              clients to achieve their exercise goals.
            </p>
            <p style={{ textAlign: 'center' }}>
              Our Pilates instructors in Singapore follow a holistic Pilates
              Training approach and are skilled at evaluating a person’s entire
              being: physically, cognitively, emotionally, and spiritually.
            </p>
            <p style={{ textAlign: 'center' }}>
              We pride ourselves on offering the best Pilates reformer sessions
              within the best Pilates studio environment. Our instructors are
              involved in continuing education courses to expand their knowledge
              and stay up to date with the latest developments in exercise
              science to deliver you the best results from your practice. If
              you’re interested, you can straight away take a look at our
              Pilates Classes in Singapore for bookings.
            </p>
            <p style={{ textAlign: 'center' }}>
              Beyond our Pilates Courses, we also have Pilates Instructors
              Training at four different locations in Singapore for individuals
              who want to pursue a career as a Pilates expert. Breathe Pilates
              Teacher Training Courses in Singapore not only provide you with a
              Pilates certification but also equips you with the practical
              abilities you’ll need to become a top-notch Pilates instructor.
            </p>
          </>
        )}
      </div>
