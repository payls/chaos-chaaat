...
/**
 * Resend verification email to user with specific email
 ...
 * @returns {Promise<{data: {}, status: string}>}
 */
export async function loginEmail(data, showMessage = false) {
  const response = await Axios({
    url: `${config.apiUrl}/v1/staff/auth/login/email`,
    withCredentials: true,
    method: 'post',
    headers: {
      Accept: 'application/json',
...
export async function loginGoogle(data, showMessage) {
  const response = await Axios({
    url: `${config.apiUrl}/v1/staff/auth/login/google`,
    method: 'post',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
...
export async function logout(data, showMessage) {
  const response = await Axios({
    url: `${config.apiUrl}/v1/staff/auth/logout`,
    method: 'post',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
...
export async function verifySessionToken(data, showMessage) {
  const response = await Axios({
    url: `${config.apiUrl}/v1/staff/auth/session/verify`,
    method: 'post',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
...
export async function forgotPassword(data, showMessage) {
  const response = await Axios({
    url: `${config.apiUrl}/v1/staff/auth/password/forgot`,
    withCredentials: true,
    method: 'post',
    headers: {
      Accept: 'application/json',
