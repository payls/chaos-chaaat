    ...
    return (
      <main id="invest-ogps-expat-root" className="personal">
        <section>
          ...
          <img
            src={'https://cdn.yourpave.com/landing_pages/ogps/b1.png'}
            alt="Pave"
            width={'100%'}
          />
          <img
            src={'https://cdn.yourpave.com/landing_pages/ogps/b2.png'}
            alt="Pave"
            width={'100%'}
          />
          <img
            src={'https://cdn.yourpave.com/landing_pages/ogps/b3.png'}
            alt="Pave"
            width={'100%'}
          />
          <img
            src={'https://cdn.yourpave.com/landing_pages/ogps/b4.png'}
            alt="Pave"
            width={'100%'}
          />
          <img
            src={'https://cdn.yourpave.com/landing_pages/ogps/b55.png'}
            alt="Pave"
            width={'100%'}
          />
          <img
            src={'https://cdn.yourpave.com/landing_pages/ogps/b6.png'}
            alt="Pave"
            width={'100%'}
          />
          <img
            src={'https://cdn.yourpave.com/landing_pages/ogps/b7.png'}
            alt="Pave"
            width={'100%'}
          />
          <div
