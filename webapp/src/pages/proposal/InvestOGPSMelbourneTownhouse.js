    ...
    return (
      <main id="invest-ogps-park-quarter-root">
        ...
        <section className="container mt-4 mb-5">
          <h5 className="header-1 mb-5">Melbourne Townhouse</h5>
          <p className="p-center ">
            Melbourne Townhouse One Global Group proudly presents brand
            new-Melbourne townhouses in an established, leafy and family suburb
            located only 12km north of Melbourne CBD, surrounded by reservoirs,
            parklands, with direct bike rail to the city and nearby local
            village offering a wide selection of shopping, dining, bars and
            cafes.
          </p>
        </section>
        <section className="header-1 my-5">
          <div className="container d-flex pg " style={{ gap: '10px' }}>
            <div style={{ flex: 'auto' }}>
              <img
                src={
                  'https://20789915.fs1.hubspotusercontent-na1.net/hub/20789915/hubfs/48DS%20FACADE_R03_v2.jpg?width=1200&length=1200&name=48DS%20FACADE_R03_v2.jpg'
                }
                width={'100%'}
                height={'337px'}
            ...
            <div style={{ flex: 'auto' }}>
              <img
                src={
                  'https://20789915.fs1.hubspotusercontent-na1.net/hub/20789915/hubfs/48DS%20KITCHEN_R03.jpg?width=1200&length=1200&name=48DS%20KITCHEN_R03.jpg'
                }
                width={'100%'}
                height={'337px'}
                style={{ objectFit: 'cover' }}
        ...
        >
          <div className="container">
            ...
            >
              4 BED, 3 BED or 2 BED TOWNHOUSES
            </h1>
        ...
        <div className=" container mb-5" style={{ width: '390px' }}>
          ...
          <div className="container foot">
            <div className=" pt-4 d-flex blck  flex-row gap-2">
              <div style={{ flexGrow: 1, flexBasis: 0 }} className="lft">
                ...
                >
                  <span>
                    © 2023. One Global Property Services (Singapore) Pte Ltd
                  </span>
                  <br />
                  <span>
