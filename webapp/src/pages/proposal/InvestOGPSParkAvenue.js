          ...
          >
            <div className=" pt-4 d-flex blck  flex-row gap-2 banner-content">
              ...
              >
                ...
                <h3>10th / 11th June 2023 | 12 PM - 6 PM</h3>
                <h3>
                  The Great Room @ Raffles Hotel Arcade, Seah Street #02-20
                  Singapore 188719
                </h3>
            ...
            <div>
              <div style={{ textAlign: 'center' }}>
                ...
                >
                  ...
                  <ul>
                    <li>
                      <span className="ab">13% lower then Blackheath</span>
                    </li>
                    <li>
                      <span className="ab">15% lower than Greater London</span>
                    </li>
                    <li>
                      <span className="ab">23% lower than Greenwich</span>
                    </li>
                  </ul>
                </p>
              </div>
