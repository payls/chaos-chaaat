      ...
      <main id="invest-ogps-park-avenue-root">
          ...
          >
            <div className=" pt-4 d-flex blck  flex-row gap-2 banner-content">
              ...
              >
                ...
                >
                  獲獎發展商Galliard Homes呈獻Park Avenue Place，坐落於Deptford
                  Park正對面。
                </p>
                <p
                  style={{
                ...
                >
                  項目坐擁176套私人住宅單位，提供一、兩及三房平層公寓和一房、兩房複式公寓，所有單位均帶私人陽台或露台。高層公寓享有倫敦天際線全景。
                </p>
                <p
                  style={{
                    fontFamily: 'Tahoma, Arial, Helvetica, sans-serif',
              ...
              >
                ...
                >
                  ...
                  >
                    {hasCampaign
                      ? `让我们知道您是否可以参加会议，我们将为您预先注册。`
                      : `如果您有兴趣，请告诉我们，我们会与您联系。`}
                  </h3>
        ...
        >
          <div>
            ...
            <p style={{ fontFamily: 'Tahoma, Arial, Helvetica, sans-serif' }}>
              Park Avenue Place距離倫敦三大金融中心 - Canary Wharf，The City &
              London Bridge Quarter* 搭地鐵僅十五分鐘。
            </p>
            <p style={{ fontFamily: 'Tahoma, Arial, Helvetica, sans-serif' }}>
              7分鐘車程可達倫敦1區交通樞紐London Bridge及London Bridge
              Quarter。Park Avenue
              Place位處東區南岸的心臟地帶，四通八達的交通與倫敦各中心連接。
            </p>
          </div>
          <div>
            <img
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontFamily: 'Tahoma, Arial, Helvetica, sans-serif' }}>
              Park Avenue Place 正對佔地17英畝的 Deptford
              Park，廣闊開揚的綠化公園。住客距離Folkestone Gardens僅數步之遙。
            </p>
          </div>
        </section>
        <section
        ...
        >
          ...
          <div>
            <h3 style={{ textAlign: 'left', fontSize: '24px' }}>設施</h3>
            <ul>
              <li
          ...
          <div className="d-flex">
            <div>
              <div style={{ textAlign: 'center' }}>
                ...
                <p
                  style={{ fontFamily: 'Tahoma, Arial, Helvetica, sans-serif' }}
                >
                  Deptford是一個年輕人口眾多的地區，超過一半(
                  <span className="ab">54%</span>)的居民年齡在35歲及以下。
                </p>
              </div>
            </div>
            <div>
            ...
            <div>
              <div style={{ textAlign: 'center' }}>
                ...
                >
                  預計未來十年(2021 – 2031) Lewisham將會增加超過{' '}
                  <span className="ab">15,000個新家庭，增幅達12%。</span>
                </p>
              </div>
            </div>
            <div>
              <div style={{ textAlign: 'center' }}>
                ...
                >
                  <span className="ab">Deptford</span>{' '}
                  及周邊地區不斷增加的投資正推動重建發展，繼而推動當地經濟發展。
                </p>
              </div>
            </div>
            <div>
              <div style={{ textAlign: 'center' }}>
                ...
                >
                  平均來說，相較於周邊地區，Deptford 提供了一個更實惠的生活方式:
                  <ul>
                    <li>
                      較Blackheath低 <span className="ab">13%</span>
                    </li>
                    <li>
                      較大倫敦低<span className="ab">15%</span>
                    </li>
                    <li>
                      較格林威治低 <span className="ab">23% </span>
                    </li>
                  </ul>
                </p>
              </div>
            ...
            <div>
              <div style={{ textAlign: 'center' }}>
                ...
                >
                  <span className="ab">SE8 postcode</span>{' '}
                  地區的公寓平均售價持續上升:
                  <ul>
                    <li>
                      2022年<span className="ab">上升4.1%</span>{' '}
                      (相比起2021年)。
                    </li>
                    <li>
                      平均而言，較10年前高出
                      <span className="ab">74%</span>,
                      ，超過同期升幅達66%的大倫敦地區。
                    </li>
                  </ul>
                </p>
