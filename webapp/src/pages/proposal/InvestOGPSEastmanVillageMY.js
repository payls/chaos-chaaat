    ...
    return (
      <main id="invest-ogps-expat-root" className="personal">
        <section>
          ...
          <img
            src={
              'https://cdn.yourpave.com/landing_pages/ogps/eastmanvillage/1.png'
            }
            alt="Pave"
            width={'100%'}
          />
          <img
            src={
              'https://cdn.yourpave.com/landing_pages/ogps/eastmanvillage/2.png'
            }
            alt="Pave"
            width={'100%'}
          />
          ...
          <img
            src={
              'https://cdn.yourpave.com/landing_pages/ogps/eastmanvillage/3.png'
            }
            alt="Pave"
            width={'100%'}
          />
