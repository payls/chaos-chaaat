    ...
    return (
      <main id="invest-ogps-persimmon-root">
            ...
            <div className=" pt-4 d-flex blck  flex-row gap-2">
              ...
              <div style={{ flexGrow: 1, flexBasis: 0 }} className="lft">
                ...
                >
                  ...
                  >
                    {hasCampaign
                      ? `请告诉我们您是否能够参加这个会议，我们将为您预先注册。`
                      : `如果您有兴趣，请告诉我们，我们将与您联系。`}
                  </h3>
        ...
        <section className="header-1">
          <div className="container  pt-4 d-flex flex-row gap-2">
            <div className="lft">
              ...
              <p>
                我们是一家五星级建筑商，获得了全国房屋建筑联合会（HBF）颁发的奖项。这是我们始终致力于卓越并把客户放在我们所做的一切工作的核心的反映。
              </p>
              <p>
                每年在全国350多个黄金地段建造超过13,500个设计精美的新房，
                Persimmon
                是英国最成功的房屋建筑商之一，致力于最高标准的设计、建造和服务。
              </p>
              <p>
                Persimmon
        ...
        <section className="center-title mb-5">
          <h3>Persimmon 开发项目/房地产项目</h3>
          <h3>項目精選</h3>
          <h4>在英国有超过50个完美的住宅供您选择。</h4>
          <h4>
        ...
        <section className="container property-list mb-5 d-flex flex-wrap ">
          <div className="property-list-item">
            ...
            <ul>
              ...
              <li>现代化开放式厨房/餐厅——非常适合娱乐。</li>
              <li>客厅正面朝向采光良好。</li>
              <li>2房半獨立屋：開放式廚房</li>
            </ul>
            <small>
              更多的两到三居室住房可供选择，价格从247,000英镑到329,000英镑不等。
            </small>
          ...
          <div className="property-list-item">
            ...
            <ul>
              ...
              <li>带有法式落地门的现代化开放式厨房、餐厅和客厅。</li>
              <li>带有现代化装置和配件的家庭浴室。</li>
              <li>3房半獨立屋：時尚的開放式廚房、飯廳、連落地玻璃門的客廳</li>
            </ul>
            <small>
              更多的两到四居室住房可供选择，价格从335,000英镑到600,000英镑不等。
            </small>
          ...
          <div className="property-list-item">
            ...
            <ul>
              ...
              <li>带有法式落地门通往花园的开放式厨房/餐厅。</li>
              <li>客厅正面朝向采光良好。</li>
              <li>3房獨立屋：開放式廚房/飯廳，打開落地玻璃門直達花園</li>
            </ul>
            <small>
              更多的两到四居室住房可供选择，价格从274,995英镑到429,995英镑不等。
            </small>
          ...
          <div className="property-list-item">
            ...
            <small>
              更多的五卧室住房可供选择，价格从649,995英镑到694,995英镑不等。
            </small>
        ...
        <section className="center-title mb-5">
          ...
          <i>免责声明：产品和价格仅供参考。价格和可用性可能会发生变化。</i>
        </section>
