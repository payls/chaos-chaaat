...
export default React.memo(
  ({
    ...
    return (
      <main id="invest-ogps-floret-root">
        ...
        <section className="header-1 p-4 my-2">
          <div className="container invest-ogps-floret-container d-flex gg">
            <div>
              <img
                src={
                  'https://invest.ogpsglobal.com/hubfs/Floret/Floret%20Logo.png'
                }
                width={'100%'}
              />
            </div>
            <div>
              <p>
                Floret, a vibrant new community of{' '}
                <b>premium 3 and 4 bed houses</b> located in{' '}
                <b>Melbourne, Australia</b>.
              </p>
              <p>
                Designed by <b>award-winning architects</b> Rothelowman and
                landscaped by the renowned Aspect Studios, our Floret Townhouses
                share a rich synergy between built and natural environments.
              </p>
              <p>
                The Floret neighbourhood is defined by its resonant sense of
                community and elegant design simplicity, with seamless proximity
                to a vast retail offering, eminent schools and university, and
        ...
        >
          <div className="container">
            ...
            >
              *8.2% avg capital growth per annum, over 10yrs
            </h1>
          </div>
        </section>
        ...
        <section className="container mt-4">
          ...
          >
            ...
            12pm - 6pm
            <br />
            One Global Sales Gallery (127 Devonshire Road Singapore 239885)
            <br />
          </p>
        </section>
