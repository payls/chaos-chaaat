    ...
    return (
      <main id="invest-ogps-root">
        ...
        <div className="container">
          <img
            src={
              'https://invest.ogpsglobal.com/hs-fs/hubfs/AT238/AT238/Screenshot%202023-09-08%20at%2012.55.14%20PM.png?width=4000&height=1518&name=Screenshot%202023-09-08%20at%2012.55.14%20PM.png'
            }
            alt="Pave"
            width={'100%'}
          />
        ...
        <section className="header-1">
          <div className="container  pt-4 d-flex flex-row gap-2 hy">
            <div className="lft">
              <h3
                style={{
                ...
                className="mt-3 mb-3"
              >
                BRAND NEW & COMPLETED & READY TO MOVE IN
              </h3>
              <h1
              ...
              >
                ...
                >
                  AT238 - Perth's Latest CBD Luxury Apartments!
                </span>
              </h1>
              <h2
                style={{ fontSize: '18px', fontWeight: 700 }}
              ...
              >
                ...
                >
                  Developed by Finbar Group - West Australia's Largest & Most
                  Trusted Apartment Developer
                </span>
              </h2>
              <ul>
                <li>50% stamp duty rebate*</li>
                <li>Situated directly at Perth CBD</li>
                <li>1, 2 & 3 bed apartment from AUD$390,000*</li>
                <li>Freehold development</li>
                <li>Inclusive of 1-2 car park</li>
                <li>FIRB eligible</li>
                <li>Estimated rental yield: up to 6.23%* gross</li>
                <li>"Finance available", only $20,000 to secure</li>
              </ul>
            </div>
            <div className="w rght" style={{ textAlign: 'center' }}>
              <img
                src={
                  'https://invest.ogpsglobal.com/hs-fs/hubfs/AT238/AT238/DSC03244-2-denoise.jpg?width=668&height=1000&name=DSC03244-2-denoise.jpg'
                }
                // width={'100%'}
                height={'500px'}
                className="mt-3"
        ...
        <div className="container">
          ...
          >
            Register for our Singapore Exclusive Event @ 23rd & 24th September
            2023
            <br />
            <div
              style={{
        ...
        <section className=" container py-3">
          <p style={{ fontSize: '10px', textAlign: 'justify', lineHeight: 1 }}>
            ...
            >
              ...
              prepared by One Global Property Services (Singapore) Pte Ltd & One
              Global Property Services (Hong Kong) Ltd for advertising and
