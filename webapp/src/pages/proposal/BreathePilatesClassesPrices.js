      ...
      <main id="breathe-pilates-root" className="greenish">
        ...
        >
          ...
          <div style={{ zIndex: 1, padding: '20px', flex: '1 50%' }}>
            <h3>Classes and Prices</h3>
            <h5>Reformer Classes & Prices in Singapore</h5>

            <p>
              Here at Breathe, a one-on-one consultation with us or together
              with our doctors is paramount to customizing the best exercise for
              you.
              <br />
              <br />
