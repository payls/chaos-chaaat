...
const photoItems = [
  {
    imgUrl: 'https://cdn.yourpave.com/landing_pages/breathe_pilates/2.jpg',
    title: 'Fat Blast',
...
the core-strengthening elements.`,
  ...
  {
    imgUrl: 'https://cdn.yourpave.com/landing_pages/breathe_pilates/3.jpg',
  ...
  {
    imgUrl: 'https://cdn.yourpave.com/landing_pages/breathe_pilates/4.jpg',
  ...
  {
    imgUrl: 'https://cdn.yourpave.com/landing_pages/breathe_pilates/5.jpg',
  ...
  {
    imgUrl: 'https://cdn.yourpave.com/landing_pages/breathe_pilates/6.jpg',
  ...
  {
    imgUrl: 'https://cdn.yourpave.com/landing_pages/breathe_pilates/7.jpg',
  ...
  {
    imgUrl: 'https://cdn.yourpave.com/landing_pages/breathe_pilates/8.jpg',
  ...
  ({
    ...
    const handleCTA = async () => {
      ...
      if (h.cmpStr(apiRes.status, 'ok')) {
        ...
        setTimeout(() => {
          window.location.href = `https://api.whatsapp.com/send/?phone=6598355683&text&type=phone_number&app_absent=0`;
        }, 1000);
      }
    };
      ...
      <main id="breathe-pilates-root" className="greenish">
        ...
        >
          <div className="d-flex justify-content-center container">
            <img
              src={
                'https://cdn.yourpave.com/landing_pages/breathe_pilates/bp_logo.png'
              }
              alt="Pave"
              height={'16px'}
              style={{ margin: '20px' }}
        ...
        >
          <div style={{ zIndex: 1, flex: '1 50%' }}>
            <div
              ...
              style={{
                background: `url(https://cdn.yourpave.com/landing_pages/breathe_pilates/1.jpg) no-repeat center center`,
                height: '345px',
              }}
            ></div>
          </div>
          <div style={{ zIndex: 1, padding: '20px', flex: '1 50%' }}>
            <h3>Your Transformation Begins Here</h3>
            <p>
              You are unique and so are your needs. With a wide variety of
              classes, we offer the most up to date methods in fitness and
              rehabilitation for everyone. Whether you choose a private session
              or group class, you will work on exercises designed for your
              body’s needs.
              <br />
              <br />
              To get started, we are offering you a complimentary Movement
              Assessment worth $200 when you sign up for any New Starter
              Package. Hurry, our promotion ends 30 April, 2023. <br />
              <br />
            </p>
            <div className="centered btn-wrap">
              {registered ? (
                <a
                  href={`https://api.whatsapp.com/send/?phone=6598355683&text&type=phone_number&app_absent=0`}
        ...
        <div style={{ textAlign: 'center' }} className="container l">
          ...
          <p style={{ textAlign: 'center' }}>
            You are unique and so are your needs. With a wide variety of
            classes, we offer the most up to date methods in fitness and
            rehabilitation for everyone. Whether you choose a private session or
            group class, you will work on exercises designed for your body’s
            needs.
          </p>
        </div>
