  ...
  ({
    ...
    return (
      <main id="invest-hendon-root">
          ...
          >
            <div className=" pt-4 d-flex blck  flex-row gap-2 banner-content">
              ...
              >
                <img
                  src={
                    'https://invest.ogpsglobal.com/hs-fs/hubfs/Wembley%20Park%20Gardens%20-%20London/image%20(8).png?width=782&height=200&name=image%20(8).png'
                  }
                  width={'80%'}
                  className="mb-5"
                />
                <div style={{ background: '#8BB6A5', padding: '20px 30px' }}>
                  <h1>Hendon Waterside</h1>
                  <h2>NW9</h2>
                  <h2>
                    An urban neighbourhood with natural beauty on its doorstep
                  </h2>
                </div>
              </div>
              <div
        ...
        <section className="container center-title mb-5 mt-5">
          <p>
            Covering over 30 acres and encompassing over 2,000 homes, Hendon
            Waterside is a unique lifestyle destination. As part of the
            multi-million pound regeneration of West Hendon, alongside
            neighbouring Brent Cross and Cricklewood the development provides an
            array of parks, leisure facilities and amenities. With an oasis of
            calm on its doorstep in the form of the beautiful Welsh Harp
            Reservoir, the rejuvenated Broadway of shops and cafés, as well as
            high-performing schools nearby, residents have it all.
          </p>
        </section>

        <section className="container center-title mb-5">
          <h3>BEAUTIFUL HOMES SURROUNDED BY THE BEST OF NORTH WEST LONDON</h3>
          <p>
            Hendon Waterside is a vibrant, perfectly located neighbourhood in
            North London. Set within expansive landscaped communal gardens and
            adjacent to the restored lakefront of the Welsh Harp Reservoir, it
            offers both beautiful surroundings and stylish interiors. Each home
            boasts upgraded premium specifications including sleek, fitted
            kitchens with integrated appliances; all designed to offer optimal
            comfort and functionality
          </p>
        </section>

        <section className="container center-title mb-5">
          <h3>WATERSIDE LIVING, JUST 20 MINUTES FROM CENTRAL LONDON</h3>
          <p>
            With Hendon Waterside's, open green spaces and excellent transport
            links to central London, just 16 minutes to reach London St Pancras
            International, there is no better place to buy
          </p>
        </section>

        <section className="container center-title mb-5">
          <img
            src={`https://invest.ogpsglobal.com/hs-fs/hubfs/Screenshot%202023-06-28%20at%208.21.28%20PM.png?width=2792&height=1696&name=Screenshot%202023-06-28%20at%208.21.28%20PM.png`}
            width={'100%'}
          />
        </section>

        <section className="container center-title mb-5">
          <h3>SHOPPING AND DINING, ON YOUR DOORSTEP</h3>
          <p>
            Hendon Waterside is excellently served by supermarkets with a
            Sainsbury's Superstore, Marks and Spencer and Waitrose just a short
            distance away, as well as an on-site Co-op as part of the
            development.
            <br />
            <br />
            When you're in need of a little retail therapy, Brent Cross is close
            by and is quickly becoming a world-class shopping and entertainment
            destination, complete with a new high street, shops, restaurants and
            leisure facilities. Nearby areas such as Hampstead, Primrose Hill
            and Belsize Park are home to pavement cafés, characterful pubs and
            independent boutiques and restaurants, while Camden Lock is famous
            for its vibrant Stable Market and eclectic shops.
          </p>
        </section>

        <section className="container center-title mb-5">
          <h3>EXCELLENT SCHOOLING AND WORLD-RENOWNED UNIVERSITIES</h3>
          <p>
            If you are looking to enrol your child or children in school, Hendon
            Waterside has a number of primary and secondary schools nearby, all
            rated ‘Outstanding' or ‘Good' by Ofsted.
            <br />
            <br />
            Not far from the Hendon Broadway is Parkfield Primary School and St
            Mary's and St John's CE Primary School, both highly respected
            primary schools.
            <br />
            <br />
            For secondary education, Barnet Hill Academy is close, as is the
            Hendon School. World-leading universities such as the London School
            of Economics and Imperial College London are also within easy
            distance; as is the University of Cambridge and the University of
            Oxford, 52 and 56 miles away respectively
          </p>
        </section>

        <section style={{ background: '#18365C' }} className="pt-4 pb-4 mt-2">
          <h1
            style={{
              color: '#ffffff',
              textAlign: 'center',
        ...
        >
          <iframe
            src={
              'https://invest.ogpsglobal.com/share/hubspotvideo/102169535080?utm_campaign=%5BSG%5D%20UK%20%7C%20London%20%7C%20EDM%20%7C%20Hendon%20Waterside%20Lead%20Gen%20Campaign%20Feb%2023&utm_source=hs_email&utm_medium=email&_hsenc=p2ANqtz-8npbPZH9pilYKKCF0ECq81rrSK0AMvQp8UqxWvog6IMIdNTT9vjR1Cprsg7ixZiYqru7d_&hsLang=en'
            }
            height={500}
            width={'100%'}
          />
        ...
        <section style={{ background: '#18365C' }} className="pt-4 pb-4 mt-2">
          ...
          >
            RSVP for the Event 22nd & 23rd July 2023!
          </h1>
          ...
          >
            Venue: Sapphire Room, The EQ Hotel
          </h1>
          ...
          >
            ...
            >
              ...
              *Prices and details correct at time of issue and subject to
              ...
              Maps & www.tfl.co.uk. †The rental yield is for general reference
              only and not guaranteed. This email has been prepared by One
              Global Property Services (Singapore) Pte Ltd (CEA Licence No.:
              L3010793D, Co. Reg. No.: 201715336R) for advertising and general
              reference only. One Global Property Services makes no guarantees,
              ...
              and warranties arising out of this document and exclude all
              liability or loss and damages arising therefrom. One Global
              Property Services (Hong Kong) Ltd and our representatives only
              work in relation to real estate located outside Hong Kong. Neither
              One Global Property Services nor its representatives are licensed
              ...
              investment beforehand. Learn more about this on our website. All
              content © Copyright 2023 One Global Property Services. All rights
              reserved.
            </span>
          </p>
        </section>
