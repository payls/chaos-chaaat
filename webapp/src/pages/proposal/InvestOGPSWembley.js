    ...
    return (
      <main id="invest-wembley-root">
            ...
            <div className=" pt-4 d-flex blck  flex-row gap-2 banner-content">
              ...
              >
                <img
                  ...
                  className="mb-5"
                />
                <div style={{ background: '#18355C', padding: '20px 10px' }}>
                  <h1>Wembley Park Gardens</h1>
                  <h2>EXPERIENCE LONDON LIVING AT ITS MOST VIBRANT</h2>
                  <p
                    style={{
                  ...
                  >
                    24th & 24th June @ The Great Room, Seah Street, Raffles
                    Hotel Arcade
                  </p>
                  <p
                    style={{
                  ...
                  >
                    Join us for the VIP Launch of Wembley Park Gardens, the
                    latest chapter in London's most exciting regeneration story
        ...
        <section className="container center-title mb-5">
          ...
          <p>
            Welcome to the latest chapter in the capital's most exciting
            regeneration story. Set in the heart of north-west London’s iconic,
            cultural hotspot, Wembley Park Gardens is a landmark new development
            of 302 high quality new homes for private sale. With fantastic
            transport links and world-class amenities on your doorstep, this
            collection of one and two-bedroom apartments presents the very
            height of modern, sustainable, city living.
          </p>
        </section>
        ...
        <section className="container center-title mb-5">
          ...
          <p>
            Wembley has leaped forward from its historic sporting roots to
            become one of the biggest regeneration projects in the UK. For
            residents, local modern amenities and open spaces have been the
            focus, with even easier connections into central London, and out to
            the likes of Fryent Park and its 260 acres of parkland.
          </p>
        </section>
        ...
        <section className="container center-title mb-5">
          ...
          <p>
            Getting around the local area is easy, with all the shops,
            restaurants and cultural facilities of Wembley just a short stroll
            away. Wembley Park Station, just a few minutes’ walk away, is well
            served by two tube lines. The Metropolitan line brings easy access
            to Baker Street, King’s Cross and Farringdon – perfect for City
            workers.
          </p>
        </section>
        ...
        <section className="container center-title mb-5">
          <img
            src={`https://invest.ogpsglobal.com/hs-fs/hubfs/Wembley%20Park%20Gardens%20-%20London/Screenshot%202023-05-12%20103504.png?width=3000&height=524&name=Screenshot%202023-05-12%20103504.png`}
            width={'100%'}
          />
        </section>

        <section className="container center-title mb-5">
          <h3>A SHOPPING HAVEN</h3>
          <p>
            Already a shopping destination for those living across the capital,
            Londoners are drawn to the variety of shops near Wembley Park tube
            station. From mainstream retailers to independent boutiques, luxury
            homeware to beauty, the choices are endless.
          </p>
        </section>

        <section className="container center-title mb-5">
          <h3>BRILLIANT EDUCATION</h3>
          <p>
            Learning potential is unrivalled in the Wembley area, with many
            schools achieving an Outstanding rating from Ofsted. And for those
            moving on to higher education, London's best universities are all
            easily accessible thanks to improved transport links.
          </p>
        </section>

        <section className="" style={{ background: '#18355C' }}>
          <h1
            style={{
              fontSize: '30px',
              fontFamily: 'tahoma,arial,helvetica,sans-serif',
        ...
        <section className="container">
          <SimpleSlider
            height={'500px'}
            images={[
              'https://20789915.fs1.hubspotusercontent-na1.net/hub/20789915/hubfs/4163_WEMBLEY-PARK-HEIGHTS_VIEW06_PODIUM_.jpg?width=1200&length=1200&name=4163_WEMBLEY-PARK-HEIGHTS_VIEW06_PODIUM_.jpg',
              'https://20789915.fs1.hubspotusercontent-na1.net/hub/20789915/hubfs/Wembley%20Park%20Gardens%20-%20London/4163_WEMBLEY-PARK-HEIGHTS_VIEW02_HUMMINGBIRD_.jpg?width=1200&length=1200&name=4163_WEMBLEY-PARK-HEIGHTS_VIEW02_HUMMINGBIRD_.jpg',
              'https://20789915.fs1.hubspotusercontent-na1.net/hub/20789915/hubfs/Wembley%20Park%20Gardens%20-%20London/Wembley%20-%20Plot%2043_Corona%20Camera0080000.jpg?width=1200&length=1200&name=Wembley%20-%20Plot%2043_Corona%20Camera0080000.jpg',
              'https://20789915.fs1.hubspotusercontent-na1.net/hub/20789915/hubfs/Wembley%20Park%20Gardens%20-%20London/Wembley%20-%20Plot%2043_Corona%20Camera0030000.jpg?width=1200&length=1200&name=Wembley%20-%20Plot%2043_Corona%20Camera0030000.jpg',
              'https://20789915.fs1.hubspotusercontent-na1.net/hub/20789915/hubfs/Wembley%20Park%20Gardens%20-%20London/Wembley%20-%20Plot%2043_Corona%20Camera0140000.jpg?width=1200&length=1200&name=Wembley%20-%20Plot%2043_Corona%20Camera0140000.jpg',
            ]}
          />
        </section>
        <section
          style={{ background: 'rgba(136, 142, 102, 1)' }}
          className="pt-4 pb-4 mt-2"
        >
