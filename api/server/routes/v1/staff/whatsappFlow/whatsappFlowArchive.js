...
/**
 * WhatsappFlowArchive handler - accepts whatsapp_flow_id as parameter and waba_id in body
 * this will call UIB api to archive a whatsapp_flow based on flow_id
...
async function handler(req, res) {
  ...
  const log = req.log.child({
    route: '/v1/staff/whatsapp-flows/:whatsapp_flow_id/archive',
    method: 'post',
    sub_id: uuidv4()
  });
  ...
  try {
    ...
    await c.whatsappFlow.update(whatsapp_flow_id, {
      status: 'deprecated',
    });
