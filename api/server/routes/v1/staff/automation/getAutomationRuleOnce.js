...
/**
 * Executes a one-time automation rule run for active rules and returns the results.
 * @async
 * @function handler
 * @param {FastifyRequest} request - The incoming request object.
 * @param {Object} request.ek - Object containing encryption keys needed for processing.
...
async function handler (request, reply) {
  ...
  const oo = await c.automationCtlr.runOnce(encryptionKeys);
  try {
