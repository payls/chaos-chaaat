...
module.exports = (fastify, opts, next) => {
  /**
   * @api {post} /v1/comment/:shortlisted_property_comment_id/react Create new comment reaction
  ...
  fastify.route({
    method: 'POST',
    url: '/shortlisted-property/comment/:shortlisted_property_comment_id/react',
    schema: {
      params: {
        type: 'object',
