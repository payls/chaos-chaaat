...
module.exports = (sequelize, DataTypes) => {
  class line_chat extends Model {
    ...
    static associate(models) {
      ...
      line_chat.belongsTo(models.agency, {
        foreignKey: 'agency_fk',
        targetKey: 'agency_id',
      });

      line_chat.belongsTo(models.contact, {
        foreignKey: 'contact_fk',
        targetKey: 'contact_id',
      });

      line_chat.belongsTo(models.agency_user, {
        foreignKey: 'agency_user_fk',
        targetKey: 'agency_user_id',
      });

      line_chat.belongsTo(models.line_message_tracker, {
        foreignKey: 'line_webhook_event_fk',
        targetKey: 'line_webhook_event_id',
      });

      line_chat.belongsTo(models.agency_channel_config, {
        foreignKey: 'sender',
  ...
  let fields = {
    ...
    line_webhook_event_fk: { type: DataTypes.STRING },
    msg_id: { type: DataTypes.STRING },
    msg_type: { type: DataTypes.STRING },
    msg_body: { type: DataTypes.TEXT },
    reply_token: { type: DataTypes.TEXT },
    quote_token: { type: DataTypes.TEXT },
    ...
    reply_to_msg_id: { type: DataTypes.TEXT },
