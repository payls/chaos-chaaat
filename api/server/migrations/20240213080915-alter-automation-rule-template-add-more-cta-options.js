...
module.exports = {
  ...
  down: async (queryInterface, Sequelize) => {
    return queryInterface.sequelize.transaction(async (transaction) => {
      await queryInterface.removeColumn('automation_rule_template', 'cta_6', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('automation_rule_template', 'cta_7', {
        transaction,
      });
      await queryInterface.removeColumn(
        'automation_rule_template',
      ...
      await queryInterface.removeColumn('automation_rule_template', 'cta_8', {
        transaction,
      });
      await queryInterface.removeColumn(
        'automation_rule_template',
      ...
      await queryInterface.removeColumn('automation_rule_template', 'cta_9', {
        transaction,
      });
      await queryInterface.removeColumn(
        'automation_rule_template',
      ...
      await queryInterface.removeColumn('automation_rule_template', 'cta_10', {
        transaction,
      });
      await queryInterface.removeColumn(
        'automation_rule_template',
