...
module.exports.makeController = (models) => {
  const { mindbody_client_contracts: model } = models;
  const ctr = {};
  ...
  ctr.create = async (record, { transaction } = {}) => {
    ...
    const mindbody_client_contract_id = h.general.generateId();
    await model.create(
      {
    ...
    return mindbody_client_contract_id;
  };
  ...
  ctr.update = async (
    ...
    await model.update(
      ...
      { where: { mindbody_client_contract_id }, transaction },
    );
    return mindbody_client_contract_id;
  };
