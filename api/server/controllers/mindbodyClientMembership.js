...
module.exports.makeController = (models) => {
  const { mindbody_client_memberships: model } = models;
  const ctr = {};
  ...
  ctr.create = async (record, { transaction } = {}) => {
    ...
    const mindbody_client_membership_id = h.general.generateId();
    await model.create(
      {
    ...
    return mindbody_client_membership_id;
  };
  ...
  ctr.update = async (
    ...
    await model.update(
      ...
      { where: { mindbody_client_membership_id }, transaction },
    );
    return mindbody_client_membership_id;
  };
