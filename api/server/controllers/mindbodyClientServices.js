...
module.exports.makeController = (models) => {
  const { mindbody_client_services: model } = models;
  const ctr = {};
  ...
  ctr.create = async (record, { transaction } = {}) => {
    ...
    const mindbody_client_services_id = h.general.generateId();
    await model.create(
      {
    ...
    return mindbody_client_services_id;
  };
  ...
  ctr.update = async (
    ...
    await model.update(
      ...
      { where: { mindbody_client_services_id }, transaction },
    );
    return mindbody_client_services_id;
  };
