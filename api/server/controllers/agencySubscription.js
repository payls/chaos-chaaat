...
module.exports.makeController = (models) => {
  const { agency_subscription: model } = models;
  const ctr = {};
  ...
  ctr.update = async (agency_subscription_id, record, { transaction } = {}) => {
   ...
   */
  ctr.findOne = async (where, { transaction, include, order } = {}) => {
