...
const manual_label = 'ogpshk parkavenue july1';
const data = [];
const file_name = 'ogpshk_july1_park_avenue_contact_list.csv';
const source_file = 'ogpshk_july1_park_avenue_list.csv';
...
async function load(result) {
  ...
  const contactOwnerID = result['Contact Owner ID'];
  const contactOwner = result['Contact owner'];
